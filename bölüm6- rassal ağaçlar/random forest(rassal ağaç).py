# -*- coding: utf-8 -*-
""" amacımız veri kümesini birden fazla parçaya bölüp her bir parçadan farklı bir karar ağacı oluşturmak ve sonrasında
bu karar ağaçların sonucunu birleştirmektir.
""" 
import numpy as np
...
# bilmediğimiz verilerin tesbitinde random forest başarılıdır. karar ağaçları ise  bildiğimiz verilerin tahmininde gayet başarılıdır
